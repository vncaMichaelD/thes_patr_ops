Sequel.migration do
  ...
  up do
    ...
    create_table(:patron_purpose) do
      primary_key :id
	...
	alter_table(:telephone) do
      add_column(:patron_reg_id, :integer)
    end
	...
	create_editable_enum('patron_material', ["book", "document", "manu", "micro", "journal", "photo", "video", "map", "oral", "oversize", "audio", "electric", "news", "museum"])
  end
